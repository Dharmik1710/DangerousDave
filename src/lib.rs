...
pub mod graphics;    // Declares a top-level module graphics from src/graphics.rs
...
pub mod animation;   // Declares a top-level module animation from src/animation.rs
pub mod state;       // Declares a top-level module state from src/state.rs
